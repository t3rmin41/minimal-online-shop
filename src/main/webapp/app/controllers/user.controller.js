(function () {
  ...
  UserController.$inject = ['$scope', '$cookies', '$routeParams', '$location', 'UserService'];

  UserController.$inject = ['$scope', '$cookies', '$routeParams', '$uibModal', '$location', 'UserService', 'ErrorController'];
  function UserController($scope, $cookies, $routeParams, $uibModal, $location, UserService, ErrorController) {
